          ...
          <div className="mt-6 sm:mt-8">
            ...
            <div className="flex flex-wrap justify-center gap-1 sm:gap-2 max-w-4xl mx-auto px-2">
              {[
                ...
                <span
                  key={index}
                  className={`px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white/90 rounded-full text-xs sm:text-sm font-medium transition-all duration-300 cursor-pointer ${tech.color}`}
                >
                  {tech.name}
                </span>
              ))}
